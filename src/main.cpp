...
//static void event_callback_function_firebase(void* arg, esp_event_base_t event_base,
//                                int32_t event_id, void* event_data);

static void event_callback_function_firebase_task(void * parm);
...
static void smartconfig_example_task(void * parm)
{
    ...
    while (1) {
        ...
        if(uxBits & CONNECTED_BIT) {
            ...
            isConnected = true;
            xTaskCreate(event_callback_function_firebase_task, "smartconfig_example_task", 4096, NULL, 3, NULL);
        }
...
static void event_callback_function_firebase_task(void* arg) {
